...
def main():
    ...
    for epoch in range(configs.TRAIN.start_epoch, configs.TRAIN.epochs):
        # train for one epoch
        tprec1, tprec5, tloss, lr = train(train_loader, model, optimizer, epoch, lr_schedule, configs.TRAIN.clean_lam, configs.TRAIN.msda, mp=mp)
...
def train(train_loader, model, optimizer, epoch, lr_schedule, clean_lam=0, msda='cutmix', mp=None):
