...
for i in 1
do
    PREFIX1=${NAME}${i}_phase1
    PREFIX2=${NAME}${i}_phase2
    PREFIX3=${NAME}${i}_phase3
    ...
    CUDA_VISIBLE_DEVICES=$GPU python -u main_fast_cutmix.py $DATA160 -c $CONFIG1 --output_prefix $PREFIX1 | tee $OUT1
    ...
    CUDA_VISIBLE_DEVICES=$GPU python -u main_fast_cutmix.py $DATA352 -c $CONFIG2 --output_prefix $PREFIX2 --resume $END1 | tee $OUT2
    ...
    CUDA_VISIBLE_DEVICES=$GPU python -u main_fast_cutmix.py $DATA352 -c $CONFIG3 --output_prefix $PREFIX3 --resume $END2 | tee $OUT3
