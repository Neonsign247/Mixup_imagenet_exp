...
PREFIX1=${NAME}_phase1_2
PREFIX2=${NAME}_phase2_2
PREFIX3=${NAME}_phase3_2
...
# CUDA_VISIBLE_DEVICES=$GPU python -u cutmix_drop_class.py $DATA352 -c $CONFIG2 --output_prefix $PREFIX2 --resume $END1 | tee $OUT2
...
CUDA_VISIBLE_DEVICES=$GPU python -u cutmix_drop_class.py $DATA352 -c $CONFIG3 --output_prefix $PREFIX3 --resume $END2 | tee $OUT3
