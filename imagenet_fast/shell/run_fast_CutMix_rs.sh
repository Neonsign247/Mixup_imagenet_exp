...
CUDA_VISIBLE_DEVICES=$GPU python -u main_fast_cutmix_rs.py $DATA160 -c $CONFIG1 --output_prefix $PREFIX1 | tee $OUT1
...
CUDA_VISIBLE_DEVICES=$GPU python -u main_fast_cutmix_rs.py $DATA352 -c $CONFIG2 --output_prefix $PREFIX2 --resume $END1 | tee $OUT2
...
CUDA_VISIBLE_DEVICES=$GPU python -u main_fast_cutmix_rs.py $DATA352 -c $CONFIG3 --output_prefix $PREFIX3 --resume $END2 | tee $OUT3
