...
CONFIG1=configs/cutmix_d1.0/configs_fast_phase1.yml
CONFIG2=configs/cutmix_d1.0/configs_fast_phase2.yml
CONFIG3=configs/cutmix_d1.0/configs_fast_phase3.yml
...
CUDA_VISIBLE_DEVICES=$GPU python -u vanilla_test1.py $DATA160 -c $CONFIG1 --output_prefix $PREFIX1 | tee $OUT1
...
CUDA_VISIBLE_DEVICES=$GPU python -u vanilla_test1.py $DATA352 -c $CONFIG2 --output_prefix $PREFIX2 --resume $END1 | tee $OUT2
...
CUDA_VISIBLE_DEVICES=$GPU python -u vanilla_test1.py $DATA352 -c $CONFIG3 --output_prefix $PREFIX3 --resume $END2 | tee $OUT3
